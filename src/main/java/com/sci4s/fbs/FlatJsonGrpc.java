...
public final class FlatJsonGrpc {
  ...
  public static final String SERVICE_NAME = "com.sci4s.fbs.FlatJson";
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.Data,
      com.sci4s.fbs.RetMsg> METHOD_CALL_RMSG = getCallRMsgMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.Data,
      com.sci4s.fbs.RetMsg> getCallRMsgMethod;
  ...
  private static volatile FlatbuffersUtils.FBExtactor<com.sci4s.fbs.RetMsg> extractorOfRetMsg;
  private static FlatbuffersUtils.FBExtactor<com.sci4s.fbs.RetMsg> getExtractorOfRetMsg() {
      if (extractorOfRetMsg != null) return extractorOfRetMsg;
      synchronized (FlatJsonGrpc.class) {
          if (extractorOfRetMsg != null) return extractorOfRetMsg;
          extractorOfRetMsg = new FlatbuffersUtils.FBExtactor<com.sci4s.fbs.RetMsg>() {
              public com.sci4s.fbs.RetMsg extract (ByteBuffer buffer) {
                  return com.sci4s.fbs.RetMsg.getRootAsRetMsg(buffer);
              }
          };
  ...
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.Data,
      com.sci4s.fbs.RetMsg> getCallRMsgMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.Data, com.sci4s.fbs.RetMsg> getCallRMsgMethod;
    if ((getCallRMsgMethod = FlatJsonGrpc.getCallRMsgMethod) == null) {
      synchronized (FlatJsonGrpc.class) {
        if ((getCallRMsgMethod = FlatJsonGrpc.getCallRMsgMethod) == null) {
          FlatJsonGrpc.getCallRMsgMethod = getCallRMsgMethod = 
              io.grpc.MethodDescriptor.<com.sci4s.fbs.Data, com.sci4s.fbs.RetMsg>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "callRMsg"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.Data.class, getExtractorOfData()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.RetMsg.class, getExtractorOfRetMsg()))
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.Files,
      com.sci4s.fbs.Reply> METHOD_M_LEARNING = getMLearningMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.Files,
      com.sci4s.fbs.Reply> getMLearningMethod;
  
  private static volatile FlatbuffersUtils.FBExtactor<com.sci4s.fbs.Files> extractorOfFiles;
  private static FlatbuffersUtils.FBExtactor<com.sci4s.fbs.Files> getExtractorOfFiles() {
      if (extractorOfFiles != null) return extractorOfFiles;
      synchronized (FlatJsonGrpc.class) {
          if (extractorOfFiles != null) return extractorOfFiles;
          extractorOfFiles = new FlatbuffersUtils.FBExtactor<com.sci4s.fbs.Files>() {
              public com.sci4s.fbs.Files extract (ByteBuffer buffer) {
                  return com.sci4s.fbs.Files.getRootAsFiles(buffer);
              }
          };
  ...
  private static volatile FlatbuffersUtils.FBExtactor<com.sci4s.fbs.Reply> extractorOfReply;
  private static FlatbuffersUtils.FBExtactor<com.sci4s.fbs.Reply> getExtractorOfReply() {
      if (extractorOfReply != null) return extractorOfReply;
      synchronized (FlatJsonGrpc.class) {
          if (extractorOfReply != null) return extractorOfReply;
          extractorOfReply = new FlatbuffersUtils.FBExtactor<com.sci4s.fbs.Reply>() {
              public com.sci4s.fbs.Reply extract (ByteBuffer buffer) {
                  return com.sci4s.fbs.Reply.getRootAsReply(buffer);
              }
          };
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.Files,
      com.sci4s.fbs.Reply> getMLearningMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.Files, com.sci4s.fbs.Reply> getMLearningMethod;
    if ((getMLearningMethod = FlatJsonGrpc.getMLearningMethod) == null) {
      synchronized (FlatJsonGrpc.class) {
        if ((getMLearningMethod = FlatJsonGrpc.getMLearningMethod) == null) {
          FlatJsonGrpc.getMLearningMethod = getMLearningMethod = 
              io.grpc.MethodDescriptor.<com.sci4s.fbs.Files, com.sci4s.fbs.Reply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "m_learning"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.Files.class, getExtractorOfFiles()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.Reply.class, getExtractorOfReply()))
                  .setSchemaDescriptor(null)
                  .build();
          }
        }
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.Chunk,
      com.sci4s.fbs.Reply> METHOD_UPLOAD1 = getUpload1Method();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.Chunk,
      com.sci4s.fbs.Reply> getUpload1Method;
  
  private static volatile FlatbuffersUtils.FBExtactor<com.sci4s.fbs.Chunk> extractorOfChunk;
  private static FlatbuffersUtils.FBExtactor<com.sci4s.fbs.Chunk> getExtractorOfChunk() {
      if (extractorOfChunk != null) return extractorOfChunk;
      synchronized (FlatJsonGrpc.class) {
          if (extractorOfChunk != null) return extractorOfChunk;
          extractorOfChunk = new FlatbuffersUtils.FBExtactor<com.sci4s.fbs.Chunk>() {
              public com.sci4s.fbs.Chunk extract (ByteBuffer buffer) {
                  return com.sci4s.fbs.Chunk.getRootAsChunk(buffer);
              }
          };
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.Chunk,
      com.sci4s.fbs.Reply> getUpload1Method() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.Chunk, com.sci4s.fbs.Reply> getUpload1Method;
    if ((getUpload1Method = FlatJsonGrpc.getUpload1Method) == null) {
      synchronized (FlatJsonGrpc.class) {
        if ((getUpload1Method = FlatJsonGrpc.getUpload1Method) == null) {
          FlatJsonGrpc.getUpload1Method = getUpload1Method = 
              io.grpc.MethodDescriptor.<com.sci4s.fbs.Chunk, com.sci4s.fbs.Reply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "upload1"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.Chunk.class, getExtractorOfChunk()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.Reply.class, getExtractorOfReply()))
                  .setSchemaDescriptor(null)
                  .build();
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.Files,
      com.sci4s.fbs.Reply> METHOD_UPLOAD2 = getUpload2Method();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.Files,
      com.sci4s.fbs.Reply> getUpload2Method;
  
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.Files,
      com.sci4s.fbs.Reply> getUpload2Method() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.Files, com.sci4s.fbs.Reply> getUpload2Method;
      ...
      synchronized (FlatJsonGrpc.class) {
        if ((getUpload2Method = FlatJsonGrpc.getUpload2Method) == null) {
          FlatJsonGrpc.getUpload2Method = getUpload2Method = 
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "upload2"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.Files.class, getExtractorOfFiles()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.Data,
      com.sci4s.fbs.Chunk> METHOD_DOWNLOAD = getDownloadMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.Data,
      com.sci4s.fbs.Chunk> getDownloadMethod;
  
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.Data,
      com.sci4s.fbs.Chunk> getDownloadMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.Data, com.sci4s.fbs.Chunk> getDownloadMethod;
    if ((getDownloadMethod = FlatJsonGrpc.getDownloadMethod) == null) {
      synchronized (FlatJsonGrpc.class) {
        if ((getDownloadMethod = FlatJsonGrpc.getDownloadMethod) == null) {
          FlatJsonGrpc.getDownloadMethod = getDownloadMethod = 
              io.grpc.MethodDescriptor.<com.sci4s.fbs.Data, com.sci4s.fbs.Chunk>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "download"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.Data.class, getExtractorOfData()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.Data,
      com.sci4s.fbs.RetMsg> METHOD_GET_ENABLE_JOB = getGetEnableJobMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.Data,
      com.sci4s.fbs.RetMsg> getGetEnableJobMethod;
  
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.Data,
      com.sci4s.fbs.RetMsg> getGetEnableJobMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.Data, com.sci4s.fbs.RetMsg> getGetEnableJobMethod;
      ...
      synchronized (FlatJsonGrpc.class) {
        if ((getGetEnableJobMethod = FlatJsonGrpc.getGetEnableJobMethod) == null) {
          FlatJsonGrpc.getGetEnableJobMethod = getGetEnableJobMethod = 
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "getEnableJob"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.Data.class, getExtractorOfData()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> METHOD_GET_SERVICE_XML = getGetServiceXmlMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getGetServiceXmlMethod;
  
  private static volatile FlatbuffersUtils.FBExtactor<com.sci4s.fbs.ReqMsg> extractorOfReqMsg;
  private static FlatbuffersUtils.FBExtactor<com.sci4s.fbs.ReqMsg> getExtractorOfReqMsg() {
      if (extractorOfReqMsg != null) return extractorOfReqMsg;
      synchronized (FlatJsonGrpc.class) {
          if (extractorOfReqMsg != null) return extractorOfReqMsg;
          extractorOfReqMsg = new FlatbuffersUtils.FBExtactor<com.sci4s.fbs.ReqMsg>() {
              public com.sci4s.fbs.ReqMsg extract (ByteBuffer buffer) {
                  return com.sci4s.fbs.ReqMsg.getRootAsReqMsg(buffer);
              }
          };
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getGetServiceXmlMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg, com.sci4s.fbs.RetMsg> getGetServiceXmlMethod;
      ...
      synchronized (FlatJsonGrpc.class) {
        if ((getGetServiceXmlMethod = FlatJsonGrpc.getGetServiceXmlMethod) == null) {
          FlatJsonGrpc.getGetServiceXmlMethod = getGetServiceXmlMethod = 
              io.grpc.MethodDescriptor.<com.sci4s.fbs.ReqMsg, com.sci4s.fbs.RetMsg>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "getServiceXml"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.ReqMsg.class, getExtractorOfReqMsg()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.RetMsg.class, getExtractorOfRetMsg()))
                  .setSchemaDescriptor(null)
                  .build();
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> METHOD_GET_MST_INFO = getGetMstInfoMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getGetMstInfoMethod;
  
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getGetMstInfoMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg, com.sci4s.fbs.RetMsg> getGetMstInfoMethod;
      ...
      synchronized (FlatJsonGrpc.class) {
        if ((getGetMstInfoMethod = FlatJsonGrpc.getGetMstInfoMethod) == null) {
          FlatJsonGrpc.getGetMstInfoMethod = getGetMstInfoMethod = 
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "getMstInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.ReqMsg.class, getExtractorOfReqMsg()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> METHOD_UPD_TBL_ATTACH4DOC_NO = getUpdTblAttach4DocNOMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getUpdTblAttach4DocNOMethod;
  
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getUpdTblAttach4DocNOMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg, com.sci4s.fbs.RetMsg> getUpdTblAttach4DocNOMethod;
      ...
      synchronized (FlatJsonGrpc.class) {
        if ((getUpdTblAttach4DocNOMethod = FlatJsonGrpc.getUpdTblAttach4DocNOMethod) == null) {
          FlatJsonGrpc.getUpdTblAttach4DocNOMethod = getUpdTblAttach4DocNOMethod = 
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "updTblAttach4DocNO"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.ReqMsg.class, getExtractorOfReqMsg()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> METHOD_INS_NEW_CUST_VD_INFO = getInsNewCustVdInfoMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getInsNewCustVdInfoMethod;
  
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getInsNewCustVdInfoMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg, com.sci4s.fbs.RetMsg> getInsNewCustVdInfoMethod;
      ...
      synchronized (FlatJsonGrpc.class) {
        if ((getInsNewCustVdInfoMethod = FlatJsonGrpc.getInsNewCustVdInfoMethod) == null) {
          FlatJsonGrpc.getInsNewCustVdInfoMethod = getInsNewCustVdInfoMethod = 
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "insNewCustVdInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.ReqMsg.class, getExtractorOfReqMsg()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> METHOD_DEL_APV_INFO4APV_UID = getDelApvInfo4ApvUIDMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getDelApvInfo4ApvUIDMethod;
  
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getDelApvInfo4ApvUIDMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg, com.sci4s.fbs.RetMsg> getDelApvInfo4ApvUIDMethod;
      ...
      synchronized (FlatJsonGrpc.class) {
        if ((getDelApvInfo4ApvUIDMethod = FlatJsonGrpc.getDelApvInfo4ApvUIDMethod) == null) {
          FlatJsonGrpc.getDelApvInfo4ApvUIDMethod = getDelApvInfo4ApvUIDMethod = 
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "delApvInfo4ApvUID"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.ReqMsg.class, getExtractorOfReqMsg()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
  ...
  public static final io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> METHOD_GET_IFDATA4NONE_IF = getGetIFData4NoneIFMethod();
  
  private static volatile io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getGetIFData4NoneIFMethod;
  
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg,
      com.sci4s.fbs.RetMsg> getGetIFData4NoneIFMethod() {
    io.grpc.MethodDescriptor<com.sci4s.fbs.ReqMsg, com.sci4s.fbs.RetMsg> getGetIFData4NoneIFMethod;
      ...
      synchronized (FlatJsonGrpc.class) {
        if ((getGetIFData4NoneIFMethod = FlatJsonGrpc.getGetIFData4NoneIFMethod) == null) {
          FlatJsonGrpc.getGetIFData4NoneIFMethod = getGetIFData4NoneIFMethod = 
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.sci4s.fbs.FlatJson", "getIFData4NoneIF"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  com.sci4s.fbs.ReqMsg.class, getExtractorOfReqMsg()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
  ...
  public static abstract class FlatJsonImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public     void callRMsg(com.sci4s.fbs.Data request,
        io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg> responseObserver)     {
      asyncUnimplementedUnaryCall(getCallRMsgMethod(), responseObserver);
    }
    
    /**
     */
    public     io.grpc.stub.StreamObserver<com.sci4s.fbs.Files> mLearning(
        io.grpc.stub.StreamObserver<com.sci4s.fbs.Reply> responseObserver)     {
      return asyncUnimplementedStreamingCall(getMLearningMethod(), responseObserver);
    }
    
    /**
     */
    public     io.grpc.stub.StreamObserver<com.sci4s.fbs.Chunk> upload1(
        io.grpc.stub.StreamObserver<com.sci4s.fbs.Reply> responseObserver)     {
    ...
    /**
     */
    public     io.grpc.stub.StreamObserver<com.sci4s.fbs.Files> upload2(
        io.grpc.stub.StreamObserver<com.sci4s.fbs.Reply> responseObserver)     {
    ...
    /**
     */
    public     void download(com.sci4s.fbs.Data request,
        io.grpc.stub.StreamObserver<com.sci4s.fbs.Chunk> responseObserver)     {
      asyncUnimplementedUnaryCall(getDownloadMethod(), responseObserver);
    }
    
    /**
     */
    public     void getEnableJob(com.sci4s.fbs.Data request,
        io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg> responseObserver)     {
    ...
    /**
     */
    public     void getServiceXml(com.sci4s.fbs.ReqMsg request,
        io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg> responseObserver)     {
    ...
    /**
     */
    public     void getMstInfo(com.sci4s.fbs.ReqMsg request,
        io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg> responseObserver)     {
    ...
    /**
     */
    public     void updTblAttach4DocNO(com.sci4s.fbs.ReqMsg request,
        io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg> responseObserver)     {
    ...
    /**
     */
    public     void insNewCustVdInfo(com.sci4s.fbs.ReqMsg request,
        io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg> responseObserver)     {
    ...
    /**
     */
    public     void delApvInfo4ApvUID(com.sci4s.fbs.ReqMsg request,
        io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg> responseObserver)     {
    ...
    /**
     */
    public     void getIFData4NoneIF(com.sci4s.fbs.ReqMsg request,
        io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg> responseObserver)     {
  ...
  public static final class FlatJsonBlockingStub extends io.grpc.stub.AbstractStub<FlatJsonBlockingStub> {
    ...
    /**
     */
    public     com.sci4s.fbs.RetMsg callRMsg(com.sci4s.fbs.Data request)     {
    ...
    /**
     */
    public     java.util.Iterator<com.sci4s.fbs.Chunk> download(
    ...
    /**
     */
    public     com.sci4s.fbs.RetMsg getEnableJob(com.sci4s.fbs.Data request)     {
      return blockingUnaryCall(
    ...
    /**
     */
    public     com.sci4s.fbs.RetMsg getServiceXml(com.sci4s.fbs.ReqMsg request)     {
      return blockingUnaryCall(
    ...
    /**
     */
    public     com.sci4s.fbs.RetMsg getMstInfo(com.sci4s.fbs.ReqMsg request)     {
      return blockingUnaryCall(
    ...
    /**
     */
    public     com.sci4s.fbs.RetMsg updTblAttach4DocNO(com.sci4s.fbs.ReqMsg request)     {
      return blockingUnaryCall(
    ...
    /**
     */
    public     com.sci4s.fbs.RetMsg insNewCustVdInfo(com.sci4s.fbs.ReqMsg request)     {
      return blockingUnaryCall(
    ...
    /**
     */
    public     com.sci4s.fbs.RetMsg delApvInfo4ApvUID(com.sci4s.fbs.ReqMsg request)     {
      return blockingUnaryCall(
    ...
    /**
     */
    public     com.sci4s.fbs.RetMsg getIFData4NoneIF(com.sci4s.fbs.ReqMsg request)     {
      return blockingUnaryCall(
  ...
  public static final class FlatJsonFutureStub extends io.grpc.stub.AbstractStub<FlatJsonFutureStub> {
    ...
    /**
     */
    public     com.google.common.util.concurrent.ListenableFuture<com.sci4s.fbs.RetMsg> callRMsg(
        com.sci4s.fbs.Data request)     {
    ...
    /**
     */
    public     com.google.common.util.concurrent.ListenableFuture<com.sci4s.fbs.RetMsg> getEnableJob(
        com.sci4s.fbs.Data request)     {
      return futureUnaryCall(
    ...
    /**
     */
    public     com.google.common.util.concurrent.ListenableFuture<com.sci4s.fbs.RetMsg> getServiceXml(
        com.sci4s.fbs.ReqMsg request)     {
      return futureUnaryCall(
    ...
    /**
     */
    public     com.google.common.util.concurrent.ListenableFuture<com.sci4s.fbs.RetMsg> getMstInfo(
        com.sci4s.fbs.ReqMsg request)     {
      return futureUnaryCall(
    ...
    /**
     */
    public     com.google.common.util.concurrent.ListenableFuture<com.sci4s.fbs.RetMsg> updTblAttach4DocNO(
        com.sci4s.fbs.ReqMsg request)     {
      return futureUnaryCall(
    ...
    /**
     */
    public     com.google.common.util.concurrent.ListenableFuture<com.sci4s.fbs.RetMsg> insNewCustVdInfo(
        com.sci4s.fbs.ReqMsg request)     {
      return futureUnaryCall(
    ...
    /**
     */
    public     com.google.common.util.concurrent.ListenableFuture<com.sci4s.fbs.RetMsg> delApvInfo4ApvUID(
        com.sci4s.fbs.ReqMsg request)     {
      return futureUnaryCall(
    ...
    /**
     */
    public     com.google.common.util.concurrent.ListenableFuture<com.sci4s.fbs.RetMsg> getIFData4NoneIF(
        com.sci4s.fbs.ReqMsg request)     {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CALL_RMSG:
          serviceImpl.callRMsg((com.sci4s.fbs.Data) request,
              (io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg>) responseObserver);
          break;
        case METHODID_DOWNLOAD:
          serviceImpl.download((com.sci4s.fbs.Data) request,
              (io.grpc.stub.StreamObserver<com.sci4s.fbs.Chunk>) responseObserver);
          break;
        case METHODID_GET_ENABLE_JOB:
          serviceImpl.getEnableJob((com.sci4s.fbs.Data) request,
              (io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg>) responseObserver);
          break;
        case METHODID_GET_SERVICE_XML:
          serviceImpl.getServiceXml((com.sci4s.fbs.ReqMsg) request,
              (io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg>) responseObserver);
          break;
        case METHODID_GET_MST_INFO:
          serviceImpl.getMstInfo((com.sci4s.fbs.ReqMsg) request,
              (io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg>) responseObserver);
          break;
        case METHODID_UPD_TBL_ATTACH4DOC_NO:
          serviceImpl.updTblAttach4DocNO((com.sci4s.fbs.ReqMsg) request,
              (io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg>) responseObserver);
          break;
        case METHODID_INS_NEW_CUST_VD_INFO:
          serviceImpl.insNewCustVdInfo((com.sci4s.fbs.ReqMsg) request,
              (io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg>) responseObserver);
          break;
        case METHODID_DEL_APV_INFO4APV_UID:
          serviceImpl.delApvInfo4ApvUID((com.sci4s.fbs.ReqMsg) request,
              (io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg>) responseObserver);
          break;
        case METHODID_GET_IFDATA4NONE_IF:
          serviceImpl.getIFData4NoneIF((com.sci4s.fbs.ReqMsg) request,
              (io.grpc.stub.StreamObserver<com.sci4s.fbs.RetMsg>) responseObserver);
          break;
        default:
